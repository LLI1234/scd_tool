...
List<String> education = ['Discontinued high-school', 'High School Graduate/GED Degree', 
...
Future<void> _submitForm() async{
  ...
  final String formatted_education = (education.indexOf(selectedEducation!)+1).toString();
  final String formatted_insurance;
  final int income = int.parse(_income);
  final int max_travel_time = int.parse(_travelTime);
  final String preferred_transportation = selectedTransportation!.toLowerCase();
  ...
  if(selectedInsurance != 'UnitedHealth Group'){
    formatted_insurance = selectedInsurance!.toLowerCase().replaceAll(' ', '_');
  }
  else{
          ...
          children: <Widget>[ 
            ...
            Padding( 
              ...
              child: TextFormField(
                ...
                validator: MultiValidator([RequiredValidator(errorText: 'Enter Date of Birth')]), 
                decoration: const InputDecoration( 
                  hintText: 'yyyy-mm-dd', 
            ...
            Padding( 
              ...
              child: TextFormField(
                ...
                validator: MultiValidator([RequiredValidator(errorText: 'Enter Address')]), 
                decoration: const InputDecoration( 
